...
const SmallSettingsTable = ({
  ...
  if (!hasSettings) {
    return (
      <div className="border border-primary-dark rounded-lg p-4">
  ...
  return (
    <div className="flex flex-row gap-2 overflow-x-auto">
      {settings.map((item, index) => (
        <div
          key={index}
          className="border border-primary-dark rounded-lg p-3 bg-background hover:bg-primary/10 transition-colors flex-shrink-0"
        >
