...
const MobileFooter = () => {
  ...
  return (
    <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-black flex flex-row items-stretch h-12 z-50 relative">
      {/* Animated indicator */}
      <motion.div
        className="absolute top-0 h-1 bg-retro-green"
        initial={false}
        animate={{
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center flex-1 ${
          activeTabIndex === 0 ? "text-retro-green" : "text-gray-400"
        }`}
        onClick={() => {
          navigate("/");
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center flex-1 ${
          activeTabIndex === 1 ? "text-retro-green" : "text-gray-400"
        }`}
        onClick={() => {
          navigate("/");
          setSelectedTab("my");
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center flex-1 ${
          activeTabIndex === 2 ? "text-retro-green" : "text-gray-400"
        }`}
