...
export TOURNAMENTS_ADDRESS=$(get_contract_address "budokan_v_1_0_2-tournament_mock")
export GAME_ADDRESS=$(get_contract_address "budokan_v_1_0_2-game_mock")
export TEST_ERC20=$(get_contract_address "budokan_v_1_0_2-erc20_mock")
export TEST_ERC721=$(get_contract_address "budokan_v_1_0_2-erc721_mock")
