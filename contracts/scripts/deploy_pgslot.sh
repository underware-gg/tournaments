...
echo "------------------------------------------------------------------------------"
echo "Cleaning..."
sozo clean --profile pgslot
echo "Building..."
sozo build --profile pgslot

#-----------------
# migrate
#
echo ">>> Migrate"
sozo migrate --profile pgslot
echo "👍"
...
export MANIFEST_FILE_PATH="./manifest_pgslot.json"
...
sozo -P pgslot execute tournament_mock initializer --calldata 0,1,$TEST_ERC20,$TEST_ERC721
sozo -P pgslot execute game_mock initializer
