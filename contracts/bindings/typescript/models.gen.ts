...
export const schema: SchemaType = {
	ls_tournaments_v0: {
		...
		entry_type: new CairoCustomEnum({ 
					criteria: [{ fieldOrder: ['token_id', 'entry_count'], token_id: 0, entry_count: 0, }],
				uniform: undefined, }),
		},
		Premium: {
		...
		Tournament: {
			fieldOrder: ['tournament_id', 'name', 'description', 'creator', 'registration_start_time', 'registration_end_time', 'start_time', 'end_time', 'submission_period', 'winners_count', 'gated_type', 'entry_premium'],
			tournament_id: 0,
			name: 0,
		description: "",
			creator: "",
		...
		TournamentConfig: {
			fieldOrder: ['contract', 'eth', 'lords', 'loot_survivor', 'oracle', 'golden_token', 'blobert', 'safe_mode', 'test_mode'],
			contract: "",
			eth: "",
			lords: "",
			loot_survivor: "",
		...
		TournamentConfigValue: {
			fieldOrder: ['eth', 'lords', 'loot_survivor', 'oracle', 'golden_token', 'blobert', 'safe_mode', 'test_mode'],
			eth: "",
			lords: "",
			loot_survivor: "",
			oracle: "",
		...
		TournamentPrize: {
			fieldOrder: ['tournament_id', 'prize_key', 'token', 'token_data_type', 'payout_position', 'claimed'],
			tournament_id: 0,
			prize_key: 0,
			token: "",
		token_data_type: new CairoCustomEnum({ 
		...
		TournamentValue: {
			fieldOrder: ['name', 'description', 'creator', 'registration_start_time', 'registration_end_time', 'start_time', 'end_time', 'submission_period', 'winners_count', 'gated_type', 'entry_premium'],
			name: 0,
		description: "",
			creator: "",
			registration_start_time: 0,
